 ...
 * @LastEditTime: 2020-09-09 15:09:18
...
<template>
	<view class="hh">
		<view class="header cu-chat align-center">
			<view class="title">高GI食物</view>
            <view class="back cuIcon-back" @click="back"></view>
			<image class="bg" src="/static/highGI.png"></image>
            <view class="info">
                <view class="t">高GI食物</view>
                <view class="desc">GI是指升糖指数，一般来讲升糖指数在55-70之间的属于中升糖指数食物，＜55属于低升糖指数食物，大于70属于高升糖指数食物。</view>
            </view>
		</view>
        <view class="content">
            <block v-for="(item,index) in list" :key="item.id">
                <view class="m">第{{index+1}}名</view>
                <food :item="item" type="I" @gotoDetail="gotoDetail(item)"></food>
            </block>
        </view>
	</view>
</template>
...
export default {
    ...
    onLoad() {
        ...
        this.list.sort((item1,item2) => item2.GI - item1.GI)
        setTimeout(function () {
            wx.hideLoading();
        }, 1500);
    },
